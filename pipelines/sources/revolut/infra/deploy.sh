...
REVOLUT_EXPENSE_START_DATE="${REVOLUT_EXPENSE_START_DATE:-${REVOLUT_START_CREATED_AT}}"
REVOLUT_EXPENSE_LOOKBACK_DAYS="${REVOLUT_EXPENSE_LOOKBACK_DAYS:-36500}"
...
REVOLUT_EXPENSE_START_DATE=${REVOLUT_EXPENSE_START_DATE},\
REVOLUT_EXPENSE_LOOKBACK_DAYS=${REVOLUT_EXPENSE_LOOKBACK_DAYS},\
